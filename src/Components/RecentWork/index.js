    ...
    return (
        <div className="RecentWork">
            <a href="https://supereats.onrender.com">
                ...
                <img src={process.env.PUBLIC_URL + "/images/SuperEats/splash.png"} alt="Kevin's Super Eats Project"/>
            ...
            <a href="https://mango-music-4c4k.onrender.com">
                ...
                <img src={process.env.PUBLIC_URL + "/images/MangoMusic/splash.png"} alt="Kevin's Mango Music Project"/>
                <p>A responsive and fun web app based on Apple Music</p>
            </a>
            <a href="https://k-bnb.onrender.com">
                <h3 id="project-text-kbnb">K-BnB</h3>
                <img src={process.env.PUBLIC_URL + "/images/K-BnB/splash.png"} alt="Kevin's K.B.N.B Project"/>
